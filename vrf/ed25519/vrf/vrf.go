...
import (
	...
	"github.com/tendermint/tendermint/vrf/ed25519/edwards25519"
	"github.com/tendermint/tendermint/vrf/ed25519/extra25519"
)
...
func NewSignerFromRaw(raw []byte) PrivateKey {
