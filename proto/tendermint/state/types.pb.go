...
type State struct {
	...
	LastBlockRandom      *types1.VrfRandom `protobuf:"bytes,16,opt,name=last_block_random,json=lastBlockRandom,proto3" json:"last_block_random,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *State) GetLastBlockRandom() *types1.VrfRandom {
	if m != nil {
		return m.LastBlockRandom
	}
	return nil
}
...
var fileDescriptor_ccfacf933f22bf93 = []byte{
	...
	,
}
...
func (m *State) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastBlockRandom != nil {
		{
			size, err := m.LastBlockRandom.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	i--
	dAtA[i] = 0x2a
	if m.LastBlockTotalTx != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.LastBlockTotalTx))
		i--
		dAtA[i] = 0x20
	}
...
func (m *State) Size() (n int) {
	...
	if m.LastBlockTotalTx != 0 {
		n += 1 + sovTypes(uint64(m.LastBlockTotalTx))
	}
...
func (m *State) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastBlockTotalTx", wireType)
			}
			m.LastBlockTotalTx = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastBlockTotalTx |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastBlockRandom", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LastBlockRandom == nil {
				m.LastBlockRandom = &types1.VrfRandom{}
			}
			if err := m.LastBlockRandom.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
